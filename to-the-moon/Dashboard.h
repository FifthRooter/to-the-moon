...
private:
	...
	Vector2f scLunarSurfaceDistanceTextContainerPosition = sf::Vector2f(-450.0f, -360.0f);
	Vector2f scLunarSurfaceDistanceTextContainerSize = sf::Vector2f(300.0f, 60.0f);

	Vector2f scLunarSurfaceDistanceValueContainerPosition = sf::Vector2f(-150.0f, -360.0f);
